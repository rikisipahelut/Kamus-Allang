...
<html lang="en">
  <head>
    ...
    <title>Login Kamus Allang</title>
  ...
  <body class="text-center">
    ...
    @csrf
      <img class="mb-4" src="/asset_sb_admin/img/logo1.ico" alt="" width="72" height="72">
      <h1 class="h3 mb-3 font-weight-normal">Kamus Allang</h1>
      @if(session('status'))
